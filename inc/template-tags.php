    ...
    function dro_web_trader_entry_footer() {
        ...
        if ('post' === get_post_type()) {
            ...
            if ($tags_list) {
                ...
                printf('<span class="tags-links">' . esc_html__('Tagged %1$s', 'dro-web-trader') . '</span>', $tags_list); // WPCS: XSS OK.
            }
        }
            ...
            comments_popup_link(
                    sprintf(
                            wp_kses(
                                    ...
                                    __('Leave a Comment<span class="screen-reader-text"> on %s</span>', 'dro-web-trader'), array(
                'span' => array(
                    'class' => array(),
                ),
                                    )
        ...
        edit_post_link(
                sprintf(
                        wp_kses(
                                ...
                                __('Edit <span class="screen-reader-text">%s</span>', 'dro-web-trader'), array(
            'span' => array(
                'class' => array(),
            ),
                                )
